...
void main() {
  ...
  final testWatchlist = <TvSeries>[testWatchlistTvSeries];
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    expect: () => [
      ...
      WatchlistTvSeriesHasData(testWatchlist),
    ],
  ...
  blocTest<WatchlistTvSeriesBloc, WatchlistTvSeriesState>(
    ...
    build: () {
      when(mockGetWatchlistTvSeries.execute()).thenAnswer((_) async => const Left(DatabaseFailure('Database Failure')));
      return watchlistTvSeriesBloc;
    },
    act: (bloc) => bloc.add(FetchWatchlistTvSeries()),
    expect: () => [
