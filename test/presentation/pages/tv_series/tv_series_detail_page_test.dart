...
void main() {
  ...
  testWidgets(
      'Watchlist button should display add icon when movie not added to watchlist',
        ...
        when(mockNotifier.tvSeriesRecommendationsState).thenReturn(RequestState.Loaded);
  ...
  testWidgets(
      'Watchlist button should display Snackbar when added to watchlist', (WidgetTester tester) async {
        when(mockNotifier.tvSeriesState).thenReturn(RequestState.Loaded);
        when(mockNotifier.tvSeries).thenReturn(testTvSeriesDetail);
        when(mockNotifier.tvSeriesRecommendationsState).thenReturn(RequestState.Loaded);
        when(mockNotifier.tvSeriesRecommendations).thenReturn(<TvSeries>[]);
